# modal windows for the NUTS glossary entries

# see below function for outputs

# function to output glossary  --------------------------------------------
make_nuts_glossary_modal_output <- function(id, trigger) {
  renderUI({
...
# outputs -----------------------------------------------------------------
# make two outputs 
output$nuts_glossary_modal <- make_nuts_glossary_modal_output(id = "nuts_glossary", trigger="btn_open_nuts_glossary")
output$nuts_glossary_modal_copy <- make_nuts_glossary_modal_output(id = "nuts_glossary_copy", trigger="btn_open_nuts_glossary_copy")
